...
export const getDesignTokens = (mode: "light" | "dark") =>
  ({
    ...
    typography: {
      ...
      fontFamilyTagline: ['"Inter-ExtraBold"', ...systemFont].join(","),
      fontFamilySystem: systemFont.join(","),
      fontWeightSemiBold: 600,
      fontWeightExtraBold: 800,
      h1: {
        fontFamily: ['"Inter-ExtraBold"', ...systemFont].join(","),
      ...
      h3: {
        fontFamily: ['"Inter-Bold"', ...systemFont].join(","),
